    ...
    return (
        <div className="grid grid-cols-2 space-x-12">
            ...
            <Link href="/protected/payments">
                <button className="grid grid-cols-1 w-full p-4 h-12 justify-items-center rounded-md text-notpurple content-center bg-purps hover:bg-ualert md:w-36">Refresh</button>
            </Link>
        </div>
    )
}